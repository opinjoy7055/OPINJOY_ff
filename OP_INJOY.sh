...
# ── Logo lines 6 hain (53 char har ek) ──
LOGO_LINES=(
    "░█████╗░██████╗░ ██╗███╗   ██╗░░░██╗░█████╗░██╗   ██╗"
    "██╔══██╗██╔══██╗ ██║████╗  ██║░░░██║██╔══██╗╚██╗ ██╔╝"
    "██║  ██║██████╔╝ ██║██╔██╗ ██║░░░██║██║  ██║ ╚████╔╝ "
...
# ── Logo ek baar flash karega (3 colors mein) ──
flash_logo() {
...
# ══════════════════ Box draw karna shuru ══════════════════
clear
box_top
box_center "⚡  O P  I N J O Y  B O T  ⚡" "$YELLOW"
box_center "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━" "$YELLOW"
box_line
...
for entry in "${MODULES[@]}"; do
    ...
    if [ $? -eq 0 ]; then
        # Upar wali line mita kar ✔ dikhao
